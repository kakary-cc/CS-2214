...
myROM[4] = {jz,   RXX, RXX, 4'b1010};  // Jump to: Output True
myROM[5] = {addi, RXX, Rg0, 4'b0001};
myROM[6] = {cmp,  Rg0, Rg3, 4'b0000};
myROM[7] = {jnz,  RXX, RXX, 4'b0011};
myROM[8] = {movi, RXX, RXX, 4'b0000};  // Output False
myROM[9] = {jmp,  RXX, RXX, 4'b0000};  // False Halt
myROM[10] = {movi, RXX, RXX, 4'b0001};  // Output True
